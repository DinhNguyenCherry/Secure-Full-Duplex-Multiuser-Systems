function [Channel] = CreateSmallScaleFading( NoSources, NoDestinations, AntennaPerSource, AntennaPerDestination)
...
for i = 1:1:NoSources
	for j=1:1:NoDestinations
		...
		Channel(:,:,j,i) = sqrt(1/2)*(randn(AntennaPerSource(i),AntennaPerDestination(j)) + 1i*randn(AntennaPerSource(i),AntennaPerDestination(j)) );
